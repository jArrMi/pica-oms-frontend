...
import {Product} from '..';
import {RankingOrderProfitRequest} from '..';
import {RankingOrderProfitResponse} from '..';
import {RankingProductRequest} from '..';
import {SearchOrderRequest} from '..';
import {SearchProductRequest} from '..';
import {SearchProductResponse} from '..';
import {User} from '..';
...
export class DefaultService {
  ...
  public getCampaings(active?: boolean, startDate?: string, endDate?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    if (startDate !== undefined && startDate !== null) {
      queryParameters = queryParameters.set('startDate', startDate as any);
    }
    if (endDate !== undefined && endDate !== null) {
      queryParameters = queryParameters.set('endDate', endDate as any);
    }
